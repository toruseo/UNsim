"""
Example: JAX differentiable simulation and gradient computation (old low-level API).

See example03_differentiable.py for the same analyses with the object-oriented API.
